...
2.Create a Java program and store values of mortgage rate and mortgage price. First, program
 should check if rate is higher than 4.5 user will not buy a house, otherwise user will 
 consider buying. Once user decides to buy a house, if price of the house is larger than 
200000 than user will take a loan, otherwise user will pay cash.
*/
		...
		if(score >=3.5) {
			System.out.println("You are eligible for scholeship");
		}else {
...
200000 than user will take a loan, otherwise user will pay cash.
		*/
		...
		if(morgRate > 4.5) {
			...
			if(morgPrice>20000) {
				System.out.println("price to high u can not get loan");
		}else {
